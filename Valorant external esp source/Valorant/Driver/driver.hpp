...
public:
	...
	{
		NtUserGetPointerProprietaryId = (Nt_UserGetPointerProprietaryId)GetProcAddress(LoadLibraryA("win32u.dll"), "NtUserGetUniformSpaceMapping");
		if (NtUserGetPointerProprietaryId != 0)
		{
			printf("NtUserGetUniformSpaceMapping: %p\n", NtUserGetPointerProprietaryId);
